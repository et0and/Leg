function MakeHeader(db, target)
{
    ...
    if(imageCode == null || imageCode == 'undefined')
      ...
      visual = `<div id="photo"><iframe frameborder="0" src="${imageCode}?rel=0"></iframe></div>`;
    ...
    else
    {
      ...
      document.getElementsByName('og:image')[0].content = "https://dvc.world/content/images/"+ imageCode;
    }
...
function MakeFooter()
{
    ...
    <div id="footer">
      <div id="footerwrap">
        ...
        <div class="credit"><a href="https://nothing.market">Hackshaw</a> © ${new Date().getFullYear()}</div>
      </div>
    </div>`;
}
